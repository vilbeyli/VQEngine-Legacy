...
public:
	static const LinearColor black, white, red, green, blue, magenta, yellow, cyan, gray, light_gray, light_blue, orange, purple, violet, medium_pruple, sun;
